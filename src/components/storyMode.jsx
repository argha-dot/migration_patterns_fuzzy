...
const PARTS = {
  "part_1": {
    title: "Story Mode",
    content: 'This feature of our project allows users to track the stories of particular characters and see the interactions, conflicts and situations they were put in either before or while they were making these movements. Furthermore, it reveals to you the larger themes or occurrences of the actual partition that occurred giving the users a larger context for the things that are unfolding in the texts. We were inspired by free world video games like "Grand Theft Auto" and "The Amazing Spiderman" to come up with this element. Here, you are immersed in a larger "free world"  where your character and you as the gamer has no direction. You can enter into a story mode, however, where through missions and objectives you follow one particular narrative and storyline.',
  ...
  "part_6": {
    title: "Gul Mohammad Third Timer",
